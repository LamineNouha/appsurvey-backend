...
/**
* Insert env variables from the .env file
*/
var useDotEnvFile = function() {
...
var initGlobalConfigFiles = function (config, assets) {
  ...
  // Setting Globbed js For Announcer files
  config.files.client.js = getGlobbedPaths(assets.client.lib.js, 'public/').concat(getGlobbedPaths(assets.client.js, ['public/']));

  // Setting Globbed css files
  config.files.client.css = getGlobbedPaths(assets.client.lib.css, 'public/').concat(getGlobbedPaths(assets.client.css, ['public/']));
/*
  config.files.client.user = {} ;
  // Setting Globbed js For admin files
  config.files.client.user.js = //getGlobbedPaths(assets.client.lib.js, 'public/')
       getGlobbedPaths(assets.client.user.lib.js, ['public/'])
    //  .concat(getGlobbedPaths(assets.client.js, ['public/']))
      .concat(getGlobbedPaths(assets.client.user.js, ['public/']));

  // Setting Globbed css files
  config.files.client.user.css =  getGlobbedPaths(assets.client.lib.css, 'public/')
      .concat(getGlobbedPaths(assets.client.user.lib.css, ['public/']))
      //.concat(getGlobbedPaths(assets.client.css, ['public/']))
      .concat(getGlobbedPaths(assets.client.user.css, ['public/']));
*/
